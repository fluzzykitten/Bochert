...
public class graph {
	...
	private boolean optimize_all_set_memory = true;
...
//		graph g = new graph(50,10);
		...
		//	graph g = new graph("keller6.clq");		int[] r = null, x = null;
		int[] p = g.find_P();
		...
		g.optimize_all_set_memory = false;
		long start = System.currentTimeMillis();
		int[] temp = g.pre_Bochert();
		long elapsedTimeMillis = System.currentTimeMillis()-start;
		
		System.out.println("max clique from unoptimized Bochert is: ");
		System.out.println(g.array2string(temp));
